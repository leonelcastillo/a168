...
# Personal:
- Juan Rondon (Plomero)
- Jhonattan Rivas (Ayudante)

# Actividades
## 1.  Actividad:  Adaptación de duchas inteligentes
    Cantidad:   5
    Material:   
        5 duchas x 2 puntos de agua x 4 codos
        40 codos lisos 20mm ppr
    Equipo:     
...
## 4.  Actividad:  Punto de agua Cascada de piscina
    Cantidad:   1
    Material:
        1 Adaptador macho 2"
        1 Reduccion 2x1 1/2"
...
## 5.  Actividad:  Calentador nuevo nivel 1
    Cantidad:   1
    Material:   
        ​**Tapon Macho Roscado 20mm Termofusion PPR (Termofusion)	2,00	Unidades
        **Codo Liso 25mm 90º Termofusion PPR (Termofusion)	6,00	Unidades
        **Anillo Reductor Liso De 25 X 20mm Termofusion PPR (Termofusion)	2,00	Unidades
        **Tubo 1/2" (20mm) x 4m Agua Caliente Termofusion PPR (Tubrica)	1,00	Unidades
        **Tubo 3/4" 25mm x 4m Agua Caliente Termofusión PPR (Tubrica)	2,00	Unidades	
        *Tapón Liso 32mm Termofusión PPR (Donsen)	2,00	Unidades	
        *Codo 20mmx1/2 90° Con Rosca Hembra Termofusion PPR (Termofusion)	2,00	
    Equipo:     Maquina de termofusion
                Cortatubos
                Martillo y cincel
    Promesa:    
    Consultas:  
    Observaciones: 
        Medidas del calentador  18cm x 36cm

## 6.  Actividad:  Adaptacion de centros de piso de 2" a 3"
    Cantidad:   7/20
    Material:   
        1 pega azul PVC (en uso)
        **Reducción de 3" a 2" PVC Agua Servida (Pavco)	20,00	Unidades
    Equipo:
        Martillo y cincel
    Promesa:
    Consultas:
